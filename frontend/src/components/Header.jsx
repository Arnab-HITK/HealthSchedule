  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-5 md:px-8 lg:px-15'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
            ...
            <p>Simply browse through our extensive list of trusted doctors,<br className='hidden sm:block'/>schedule your appointments hassle-free.
            </p>
        </div>
        <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-lg m-auto md:m-0 hover:scale-105 transition-all duration-300'>
